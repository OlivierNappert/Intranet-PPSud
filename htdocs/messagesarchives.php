...
<body style="height:100%; background-color: #888888;">
  ...
  ?>
    ...
    <table class="table">
    <tr>
      <td colspan="3"><h2>Messages archivés</h2></td>
      <td colspan="1"><a href="messagesenvoyes.php">Messages envoyés</a></td>
  ...
  <?php
      $messages = $bdd->getArchivedMessagesById($_SESSION['id']);
        ...
        <tr>
          ...
          <td>
            <a href="seeMessage.php?idMessage=<?php echo $row['id']?>">Voir le message</a> / 
              <a href="archiveMessage.php?id=<?php echo $row['id']?>">Désarchiver</a> / 
